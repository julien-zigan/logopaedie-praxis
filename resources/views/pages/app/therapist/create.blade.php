    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-gray-100 overflow-hidden">
            ...
            <div class="bg-blue-600 px-8 py-6">
                <h2 class="text-xl font-bold text-white">Neuen Therapeuten anlegen</h2>
                <p class="text-slate-400 text-sm">Füllen Sie die Felder aus, um ein neues Teammitglied hinzuzufügen.</p>
            </div>

            <form action="/therapists" method="POST" class="p-8 space-y-6">
                @csrf
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <select name="specialization"
                                ...
                                <option value="Neurologische Logopädie">Neurologische Logopädie</option>
                                <option value="Stimmstörungen">Stimmstörungen</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-end gap-4 pt-6 border-t border-slate-100">
                    ...
                    <button type="submit"
                        class="bg-blue-600 text-white px-8 py-3 rounded-2xl font-bold shadow-lg shadow-blue-200 hover:bg-blue-700 hover:-translate-y-0.5 active:scale-95 transition-all flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
