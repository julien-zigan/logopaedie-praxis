    ...
    return (
        <section className="mx-auto flex max-w-[335px] flex-col items-center py-16 text-center lg:max-w-4xl lg:py-24">
            ...
            <p className="mb-10 max-w-2xl leading-relaxed text-gray-600 dark:text-gray-400">
                Diese Plattform dient als Demonstration meiner Kenntnisse in der Webentwicklung.
                Erstellt mit <strong>Laravel, React und Tailwind CSS</strong>, vereint dieses Projekt
                moderne Architektur mit einer intuitiven Benutzererfahrung für therapeutische Anwendungen.
            </p>
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
                <Link
                    href={register()}
                    className="inline-block rounded-xl bg-green-600 px-8 py-3 text-sm font-bold uppercase tracking-wider text-white transition-all hover:bg-green-700 hover:shadow-lg hover:shadow-green-500/20 active:scale-95"
                >
                    Demo starten
                </Link>
                <Link
